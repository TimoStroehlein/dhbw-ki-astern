...
class ValidateResources(AStarValidation):
    ...
    def test_Search_ShouldTakeCheaperPath(self):
        AStarValidation.set_up_test_method('cheapest', Node((2, 0, 0)))
    ...
    def test_SearchNotPossible_ShouldReturnFalse(self):
        AStarValidation.set_up_test_method('impossible', Node((2, 0, 0)))
    ...
    def test_LadderUp_ShouldTakeTwo(self):
        AStarValidation.set_up_test_method('simple_links', Node((0, 0, -1)))
    ...
    def test_Open_ShouldTakeOne(self):
        AStarValidation.set_up_test_method('simple_links', Node((0, 1, 0)))
    ...
    def test_Door_ShouldTakeTwo(self):
        AStarValidation.set_up_test_method('simple_links', Node((1, 0, 0)))
    ...
    def test_BlastWall_ShouldTakeThree(self):
        AStarValidation.set_up_test_method('blasting', Node((1, 0, 0)))
