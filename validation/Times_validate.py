...
class ValidateTimes(AStarValidation):
    ...
    def test_EnergyCooldown_ShouldRegardCooldownOfFive(self):
        AStarValidation.set_up_test_method('energy', Node((2, 0, 0)), Node((0, 0, 0)))
    ...
    def test_RegenerationDoor_ShouldReduceRegenerationTimeByTwo(self):
        AStarValidation.set_up_test_method('regeneration_door', Node((2, 0, 0)), Node((0, 0, 0)))
    ...
    def test_RegenerationOpen_ShouldReduceRegenerationTimeByOne(self):
        AStarValidation.set_up_test_method('regeneration_open', Node((1, 1, 0)), Node((0, 0, 0)))
    ...
    def test_RegenerationLadderUp_ShouldReduceRegenerationTimeByTwo(self):
        AStarValidation.set_up_test_method('regeneration_ladder_up', Node((1, 0, -1)), Node((0, 0, 0)))
    ...
    def test_RegenerationLadderDown_ShouldReduceRegenerationTimeByPointFive(self):
        AStarValidation.set_up_test_method('regeneration_ladder_down', Node((1, 0, 1)), Node((0, 0, 0)))
